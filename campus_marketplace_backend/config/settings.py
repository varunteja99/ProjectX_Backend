...
# WebSocket ALLOWED_HOSTS (for AllowedHostsOriginValidator)
# This allows WebSocket connections from these origins
ALLOWED_HOSTS.extend(['localhost:3000', '127.0.0.1:3000'])
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'campus_marketplace'),
...
LANGUAGE_CODE = 'en-us'
TIME_ZONE = 'America/Indiana/Indianapolis'  # Fort Wayne timezone
USE_I18N = True
USE_TZ = True
